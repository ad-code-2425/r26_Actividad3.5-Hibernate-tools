...
public class TiposBasicos  implements java.io.Serializable {
    ...
    public TiposBasicos(int inte, Long bigint1, Short smallint1, Float float1, Character character1, Byte byte1, Boolean bit1, String stri, Date dateDate, Time timeTime, Timestamp dateTime2, String texto, byte[] binario, BigDecimal bigDecimal) {
       this.inte = inte;
